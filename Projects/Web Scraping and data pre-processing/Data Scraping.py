...
chrome_path = r"C:\Users\krtej\Downloads\Compressed\chromedriver_win32\chromedriver.exe"
...
input_field=driver.find_element("xpath",'//input[@class="_3704LK"]')
input_field.send_keys('gaming laptop')
sleep(5)
##SEARCH BUTTON
search_enter=driver.find_element("xpath",'//button[@type="submit"]')
search_enter.click()
sleep(3)
